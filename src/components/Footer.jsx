      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap justify-between">
          <div className="w-full md:w-1/4 mb-8 md:mb-0">
            ...
            <p className="text-gray-400">Empowering agencies with AI-driven solutions.</p>
          </div>
          <div className="w-full md:w-1/4 mb-8 md:mb-0">
          ...
          <div className="w-full md:w-1/4 mb-8 md:mb-0">
            ...
            <ul className="space-y-2">
              <li><a href="https://notion.agencyhive.ai/AgencyHive-ai-Privacy-Policy-1265b144f30080e1b9e5fb98741cb547" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white">Privacy Policy</a></li>
              <li><a href="https://notion.agencyhive.ai/Terms-of-Service-for-AgencyHive-ai-1265b144f30080648936ebca7791cc30" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white">Terms of Service</a></li>
            </ul>
          </div>
